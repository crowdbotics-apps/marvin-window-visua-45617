"""
Django settings for marvin_window_visua_45617 project.
...
ROOT_URLCONF = 'marvin_window_visua_45617.urls'
...
WSGI_APPLICATION = 'marvin_window_visua_45617.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "marvin_window_visua_45617 API",
    "DESCRIPTION": "API documentation for marvin_window_visua_45617 App",
    "VERSION": "v1",
}
